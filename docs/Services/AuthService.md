...
2. Berdasarkan informasi tersebut, layanan ini akan mencari profil lengkap pengguna di dalam basis data (melalui objek Repositori Generik / IGenericRepository).
